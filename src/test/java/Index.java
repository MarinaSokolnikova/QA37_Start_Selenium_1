...
public class Index {
    ...
    public void setUp(){
        ...
        wd = new ChromeDriver();
        wd.get("file:///C:/Users/honor/Downloads/index.html");
    }
    ...
    public void cssLocators(){
        ...
        WebElement link = wd.findElement(By.linkText("Item 1"));
        WebElement link1 = wd.findElement(By.partialLinkText("m 1"));

        WebElement inp = wd.findElement(By.cssSelector("[placeholder='Type your surename']"));
        // start
        WebElement inp1 = wd.findElement(By.cssSelector("[placeholder^='Type']"));
        // end
        WebElement inp2 = wd.findElement(By.cssSelector("[placeholder$='surename']"));
        // contains
